...
## Take the extracellular expression in each passage (mean and sd)
...
## Take the intracellular expression in each passage (mean and sd)
...
write.xlsx(toxo.tab.means.sd.qval, '../Input/toxo_cdc/tables/lab_adapt_mean_sd.xlsx')
